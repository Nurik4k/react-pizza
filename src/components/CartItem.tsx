...
import { addProduct, decrProduct, removeProduct } from '../redux/slices/cart/slice';
...
const CartItem: React.FC<CartItemProps> = ({ id, imageUrl, name, price, count, size, type }) => {
  ...
  return (
    <div className='cart__item'>
      ...
      <div className='cart__item-remove'>
        <div onClick={handleClickClear} className='button button--outline button--circle'>
          <svg
            width='10'
            height='10'
            viewBox='0 0 10 10'
